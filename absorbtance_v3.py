...
def get_arrayproperties (num):
    # Important import filter spectra
    with open('filter/var/setA/c=50/'+str(num)+'.csv', 'r', encoding='utf-8-sig') as f:
...
for number_of_filter in range(5,21):
    (filter_properties, axis_cm)=get_arrayproperties(number_of_filter)
    ...
    print('number of filters is '+str(number_of_filter))
